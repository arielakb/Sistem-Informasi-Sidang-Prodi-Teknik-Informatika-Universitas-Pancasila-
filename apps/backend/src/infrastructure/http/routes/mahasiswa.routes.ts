...
router.post('/logbook', RoleMiddleware(['MAHASISWA']), uploadSingle('fileBukti'), mahasiswaController.createLogbook);
router.post('/berkas-sidang', RoleMiddleware(['MAHASISWA']), uploadSingle('file'), mahasiswaController.uploadBerkasSidang);
router.post('/berkas-final', RoleMiddleware(['MAHASISWA']), uploadMultiple(['naskah', 'pengesahan', 'berkasLain']), mahasiswaController.uploadBerkasFinal);
